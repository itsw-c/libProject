    ...
    <>
      ...
      <div className="flex flex-col md:flex-row min-h-screen">
        ...
        <div className="flex-1 p-10">
          ...
          {/* 메인 몸통 */}
          <div className="w-[full] h-[1050px] bg-amber-50 rounded border-4 border-orange-50 mt-10 p-10 pl-10">
            {/* 인사말 */}
            ...
            <div className="pt-20 text-xl">
              <div className="pb-10">
                IT 소프트웨어과 강다연, 강보은입니다.
                <br />
                ITSW도서관을 찾아주신 여러분을 환영합니다.
                <br />
              </div>
              <div className="pb-10">
                간단하고 재미있는 독서를 목표로 온라인 전용 ITSW도서 웹사이트를
                개발하였습니다.
                <br />
                대출/반납 뿐 아니라 도서검색기능, 일정확인, 출석체크이벤트, 등등
                각종 서비스를 이용하며
                <br />
                독서활동에 흥미를 유발함에 있어 노력하고 있습니다.
              </div>
              <div className="pb-10">
                앞으로도 열린마당의 이야기와 Q&A를 통한 의견들을 적극 반영해
                <br />
                보다 양질의 시스템을 제공하는 환경으로 나아갈 것입니다.
              </div>
              <div>
                ITSW도서관은 IT학부생들의 성장과 발전을 응원하고 지지하겠습니다.
                <br />
