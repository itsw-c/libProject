...
const JoinPage = () => {
  ...
  return (
    <div className="relative flex flex-col w-full h-[60rem] bg-[#fffce6] z-0">
      {' '}
      {/* z-[-1] 제거 */}
      <img
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative z-10">
                  {' '}
                  {/* 부모 컨테이너의 z-index를 낮춤 */}
                  <input
                    type="text"
                    name="userid"
                    value={formData.userid}
                    onChange={handleChange}
                    className="w-60 border border-[#d9d9d9] rounded-[5px] p-2 z-20 relative"
                    placeholder="아이디를 입력하세요"
                  />
                  <button
                    onClick={checkDuplicate}
                    className="w-15 border bg-[#161042] rounded-[5px] p-2 text-[#ffffff] ml-3 z-20 relative"
                  >
                    중복확인
                  </button>
                </div>
